...
template <> constexpr inline auto LSystem::qt_create_metaobjectdata<qt_meta_tag_ZN7LSystemE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(enum PlantPreset)>(6, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 7, 8 },
        }}),
        // Slot 'updateAnimation'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'playGrowthSound'
...
void LSystem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onAnimateClicked(); break;
        case 2: _t->onColorClicked(); break;
        case 3: _t->onSaveClicked(); break;
        case 4: _t->onPresetChanged((*reinterpret_cast<std::add_pointer_t<enum PlantPreset>>(_a[1]))); break;
        case 5: _t->updateAnimation(); break;
        case 6: _t->playGrowthSound(); break;
